...
#
# Optional env vars:
#   IMAGE_REPO  - destination image (default: quay.io/openshift-online/rosa-regional-platform-api)
#   GIT_SHA     - commit SHA to tag the image with (default: git rev-parse HEAD)

set -euo pipefail

IMAGE_REPO="${IMAGE_REPO:-quay.io/openshift-online/rosa-regional-platform-api}"
